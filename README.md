...
- The [Snap *!*  Programming Language](https://en.wikipedia.org/wiki/Snap!_(programming_language)) Project. Thanks to the University of California, Berkeley and to the SAP company for the great free online [Snap *!* course](https://open.sap.com/courses/snap1). 
