...
(The [new extension](https://snap.berkeley.edu/snap/libraries/mqttExtension.js) is available in the Snap *!* library list as "MQTT" and does not need the activation of JavaScript extensions)
