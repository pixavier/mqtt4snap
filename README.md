...
## Try the official MQTT extension at:  [Hello World! (Without SSL)]([http://snap.berkeley.edu/versions/dev/snap.html](http://extensions.snap.berkeley.edu/snap/snap.html)#open:http://raw.githubusercontent.com/pixavier/mqtt4snap/master/upgrades/HelloWorldMQTT.xml)
...
If you want to import the old MQTT4Snap *!* blocks library, copy the following URL to the clipboard, and then paste it when importing into Snap *!*:
...
We can combine Snap *!* programs with a [remote joystick](https://pixavier.github.io/mqtt4snap/LateralProjects/joystick/index.html) via MQTT (see [LateralProjects](https://github.com/pixavier/mqtt4snap/tree/master/LateralProjects/joystick)).
